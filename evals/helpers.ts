 ...
 * agent shells out to look at the repository before deciding — reading a manifest, listing a
 ...
 * to change something. The corpus is what proves the tree was left alone, because it diffs it.
 */
