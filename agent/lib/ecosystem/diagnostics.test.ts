...
/**
 * Every excerpt below is real output captured from the fixture corpus by
 * `scripts/capture-failures.ts`, not a hand-written approximation. Parsers written against imagined
 * log formats pass their own tests and fail on the first real repository.
 */
