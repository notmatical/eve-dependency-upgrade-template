 ...
 * upgrade bot, but the moment the agent edits the manifest — adding the adapter package a major
 * split out, say — the lockfile is stale by definition, and a frozen install would fail for a
