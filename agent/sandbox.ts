 ...
 * is what lets `bun run corpus` grade the fixture corpus locally with no cloud account. A template
 ...
 * — the install step exits non-zero and `run_checks` reports it — but it is why the README asks for
 * Docker to run the corpus.
 *
